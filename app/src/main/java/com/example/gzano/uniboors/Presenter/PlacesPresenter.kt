 ...
 */
class PlacesPresenter(private val placesFragmentView: PlacesFragmentView) : Presenter {

    private val databaseRef = FirebaseDatabase.getInstance().getReference("CesenaCampus")
